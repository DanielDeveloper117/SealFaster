...
// ////////////////////////////////////////////////// @LISTENING DE EVENTOS EN EL DOM
                ...
                $(`#selectorMaterial_m${i}, #inputCantidad_m${i}`).on(`input change`, function() { 
                    ...
                    mostrarBtnBillets(elMaterial, laCantidad, window[`DIMENSIONES_VALIDAS_m${i}`]);
                });
                // **** MODAL DE BILLETS DE INVENTARIO CNC
                ...
                // *******************************************
                // quitar la representacion del % de aprovechamiento
                $(`#btnCerrarModalBillets_m${i}, #btnQuitarCircle_m${i}`).on('click', function(){
                    $(`#containerBodyModalBillets_m${i}`).css("width", "100%");
                    $(`#container38_m${i}`).addClass(`d-none`).css("width", "0%");
                    $(`#containerCircleBillet_m${i}`).addClass(`d-none`);
                    $(`#circuloSvg_m${i}`).addClass(`d-none`);
                    $(`#btnQuitarCircle_m${i}`).addClass(`d-none`);
                });
