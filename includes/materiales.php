<?php for ($i = 1; $i <= $cantidadMateriales; $i++): ?>
    <form id="estimateForm_m<?= $i ?>" method="post" > 
        <section id="sectionContainerMaterial_m<?= $i ?>" class="d-none section-container">
            <?php
                $numeroMaterial="";
            ...
            <div class="d-flex col-12 flex-column gap-1 flex-md-row justify-content-between align-items-md-start align-items-center">
                ...
                <div class="controles pb-5 d-flex col-9 flex-column border-gray">
                    ...
                    <div id="containerPags_m<?= $i ?>" class="d-flex">
                        <div id="pag1_m<?= $i ?>" class="d-flex col-12 flex-column-reverse flex-md-row justify-content-between mt-4" >
                            ...
                            <div class="col-12 col-md-6 d-flex flex-column">
                                ...
                                <div class="d-flex flex-column align-items-start" style="height:100%;">
                                    ...
                                    <button id="btnBillets_m<?= $i ?>" type="button" class="d-none btn-disabled mb-2" data-bs-toggle="modal" data-bs-target="#modalBillets_m<?= $i ?>" disabled>Ver billets disponibles</button>
