                                ...
                                if (data.success) { 
                                    $('#modalFinalizar tbody').append(`
                                        <tr>
                                            ...
                                            <input type="hidden" tabindex="-1" name="mm_merma" class="mm_merma_teorica" value="">
                                            <input type="hidden" tabindex="-1" name="mm_merma" class="mm_sumatoria_sellos" value="">
                                            <input type="hidden" tabindex="-1" name="mm_merma" class="mm_merma_real" value="">
                                            ...
                                            <td><input type="number" class="input-text pz_maquinadas" value="" step="1" min="0"></td>
                                            <td><input type="number" class="input-text altura_pz" name="altura_pz" value="" step="0.01" min="0"></td>
                                            <td><input type="number" class="input-text mm_usados" name="mm_usados" value="" step="0.01" min="0"></td>
                                            <td><input type="number" class="input-text long_t_sellos" name="total_sellos" value="" step="0.01" min="0"></td>
                                            <td><input type="number" class="input-text merma_corte" name="merma_corte" value="" step="0.01" min="0"></td>
                                        ...
                                        <tr class="row-justificar ">
                                            <td colspan="11">
                                                <div class="d-flex flex-column justify-content-start align-items-start">
                                                    <label class="mb-2">Justificación de merma de <strong>${data.billetResult["lote_pedimento"] || ''}</strong>:</label> 
                                                    <input type="text" tabindex="-1" class="input-text justificacion_merma" value="">
                                                </div>
                                            </td>
                                        </tr>
                                    `);
