...
<head>
    ...
    <link rel="stylesheet" href="<?= controlCache('../assets/css/select-familia.css'); ?>">
...
<?php include(ROOT_PATH . 'includes/user_control.php'); ?>
    ...
    <section class="d-flex flex-column col-12 justify-content-center align-items-center">        
        <div id="containerFamily" class="cards gap-3">
            <a class="card" href="select_perfil.php?fam=rotary">
            ...
            <a class="card" href="select_perfil.php?fam=piston">
            ...
            <a class="card" href="select_perfil.php?fam=backup">
            ...
            <a class="card" href="select_perfil.php?fam=guide">
            ...
            <a class="card" href="select_perfil.php?fam=wipers">
            ...
            <a class="card" href="select_perfil.php?fam=rod">
