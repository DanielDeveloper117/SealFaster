...
function mapearMaterial($materialParametros) {
    $mapeoMateriales = [
        "PU ROJO" => "H-ECOPUR","H-ECOPUR" => "H-ECOPUR",
        "SILICON" => "ECOSIL", "ECOSIL" => "ECOSIL", 
        "NITRILO" => "ECORUBBER 1","ECORUBBER 1" => "ECORUBBER 1",
        "VITON" => "ECORUBBER 2","ECORUBBER 2" => "ECORUBBER 2",
        "EPDM" => "ECORUBBER 3","ECORUBBER 3" => "ECORUBBER 3",
        "PU VERDE" => "ECOPUR","ECOPUR" => "ECOPUR",
        "ECOTAL" => "ECOTAL","ECOTAL" => "ECOTAL",
        "ECOMID" => "ECOMID","ECOMID" => "ECOMID",
        "VIRGEN" => "ECOFLON 1","VIRGEN" => "ECOFLON 1",
        "NIKEL" => "ECOFLON 2","NIKEL" => "ECOFLON 2",
        "MOLLY" => "ECOFLON 2","MOLLY" => "ECOFLON 2",
        "BRONCE" => "ECOFLON 3","BRONCE" => "ECOFLON 3"
    ];
